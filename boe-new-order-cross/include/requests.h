...
constexpr size_t new_order_cross_opt_field_size()
{
    return 0
#define FIELD(name, _, __) +name##_field_size
#include "new_order_cross_opt_fields.inl"
...
constexpr size_t new_order_cross_repeat_opt_field_size()
{
    return 0
#define FIELD(name, _, __) +name##_field_size
#include "new_order_cross_repeat_opt_fields.inl"
...
constexpr size_t new_order_cross_multileg_opt_field_size()
{
    return 0
#define FIELD(name, _, __) +name##_field_size
#include "new_order_cross_multileg_opt_fields.inl"
...
constexpr size_t new_order_cross_multileg_repeat_opt_field_size()
{
    return 0
#define FIELD(name, _, __) +name##_field_size
#include "new_order_cross_multileg_repeat_opt_fields.inl"
...
constexpr size_t repeat_calculate_size(const RequestType type)
{
    switch (type) {
    case RequestType::New:
        return 0;
    case RequestType::NewCross:
        return 31 + new_order_cross_repeat_opt_field_size();
    case RequestType::NewCrossMultileg:
        return 31 + new_order_cross_multileg_repeat_opt_field_size();
    }
}
...
constexpr size_t calculate_size(const RequestType type)
{
    ...
    case RequestType::NewCross:
        return 47 + new_order_cross_bitfield_num() + new_order_cross_opt_field_size();
    case RequestType::NewCrossMultileg:
        return 47 + new_order_cross_multileg_bitfield_num() + new_order_cross_multileg_opt_field_size();
    }
}
